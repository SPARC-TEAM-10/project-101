...
| CHH-81 | Individual Dashboard (mobile+web) — profile summary, "Notify donors" quick action, active-request strip linking out to CHH-36, request history, and three honest empty states (donor responses/CHH-35, notifications/CHH-34, events/CHH-37) | Claude Design (standalone draft, not yet merged into the canonical canvas — see note below) | https://claude.ai/code/artifact/28d8f6bf-cfea-421e-8c84-8be5a9954604 | 2026-09-08 |
