...
describe("RoleRedirectPage", () => {
  ...
  it("redirects to /dashboard/individual for an Individual role", () => {
    renderWithSession({ token: "t", role: "Individual", expiresAtUtc: "2099-01-01T00:00:00.000Z", mobileNumber: "9876543210" });

    expect(screen.getByText("Individual Dashboard")).toBeInTheDocument();
  });

  it("redirects to /dashboard/guest for a Guest role", () => {
    renderWithSession({ token: "t", role: "Guest", expiresAtUtc: "2099-01-01T00:00:00.000Z", mobileNumber: "9876543210" });
