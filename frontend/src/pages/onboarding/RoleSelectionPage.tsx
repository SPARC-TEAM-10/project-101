...
//
// Left panel: the design draft (RoleSelectionWeb.dc.html) left this as an explicit placeholder
// ("Illustration panel, as shipped — AuthSplitLayout, new asset needed"), which is why it first
// shipped with AuthSplitLayout's stock photo. Replaced with the same solid BrandPanel treatment
// RegisterStubPage uses, per explicit direction to keep the auth flow's branding consistent
// rather than mixing photo and solid-panel styles across screens — heading/description below are
// original copy, since the draft never specified any for this panel.
  ...
  return (
    <div className="grid min-h-screen bg-sand font-sans text-ink md:grid-cols-[minmax(0,40%)_1fr]">
      <BrandPanel
        ...
        description="Individuals, hospitals, and NGOs each play a part in getting blood to the people who need it most."
      />
      ...
      <div className="relative flex min-h-screen flex-col">
        ...
        {/* Brand mark — matches MobileEntryPage's own wordmark block and the design's ".brand". */}
        <div className="flex-none px-7 pt-14 md:px-16">
