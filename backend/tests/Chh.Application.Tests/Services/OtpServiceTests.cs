...
public class OtpServiceTests
{
    ...
    [Fact]
    public async Task VerifyOtpAsync_WhenMobileNumberIsAdminNumber_IssuesTokenWithSystemAdminRole()
    {
        const string adminMobileNumber = RoleConstants.AdminMobileNumber;
        ...
        var response = await _sut.VerifyOtpAsync(
            new OtpVerifyRequest { MobileNumber = adminMobileNumber, OtpCode = "123456" }, CancellationToken.None);
